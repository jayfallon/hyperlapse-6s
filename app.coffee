...
for i in [0..3]
	...
	dot_hollow = new Layer
		superLayer: page
		width: 16*1.2, height: 16*1.2
		image: "images/dot_hollow.png"
		x: (264*1.2) + i*38.4, y: 1021*1.2
